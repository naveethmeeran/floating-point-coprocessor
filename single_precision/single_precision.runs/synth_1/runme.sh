...
HD_PWD='C:/Users/meera/single_precision/single_precision.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singlemul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singlemul.tcl
