...
HD_PWD='C:/Users/meera/single_precision/single_precision.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log singleaddsub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singleaddsub.tcl
